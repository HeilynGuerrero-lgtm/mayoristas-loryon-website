...
<meta charset="utf-8">
<title>Verificar código - Loryon</title>
...
<img src="img/logo.png" loading="lazy" alt="Logo Loryon">
    ...
    <?php if (isset($_SESSION['DEV_OTP'])): ?>
      <div class="alert info">
        <strong>Modo pruebas:</strong> tu código es 
        <strong><?= htmlspecialchars($_SESSION['DEV_OTP']) ?></strong>
      </div>
    <?php endif; ?>

    <form action="recuperar_verificar.php" method="post" class="form-recuperar">
      <label for="email">Correo electrónico</label>
      <input type="email" name="email" id="email" required placeholder="tu@correo.com">

      <label for="codigo">Código recibido</label>
      <input type="text" name="codigo" id="codigo" required maxlength="10" placeholder="(Tu número de cédula)">

      <label for="nueva">Nueva contraseña</label>
      <input type="password" name="nueva" id="nueva" required placeholder="********">
